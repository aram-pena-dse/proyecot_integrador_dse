...
#define ID_WINDOW1_TEXT_RPM 7
#define ID_WIN1_RPM 8
#define ID_BUTTONENABLER 9
#define ID_INSTRUCTIONS 10
#define ID_WIN1_SP 11
#define ID_WIN1_DC 12
#define ID_WINDOW1_TEXT_SP 13
#define ID_WINDOW1_TEXT_DC 14
...
typedef struct WINDOW2_CONTROL_BLOCK_STRUCT
{
    ...
    GX_NUMERIC_PROMPT window2_rpm_prompt;
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_window1_text_rpm;
    GX_PROMPT window1_win1_prompt;
    GX_CHECKBOX window1_buttonenabler;
    GX_PROMPT window1_instructions;
    GX_PROMPT window1_win1_prompt_sp;
    GX_PROMPT window1_win1_prompt_dc;
    GX_PROMPT window1_window1_text_sp;
    GX_PROMPT window1_window1_text_dc;
