...
/*  Date (dd.mm.yyyy):  1. 3.2019   Time (hh:mm): 16:14                        */
/*******************************************************************************/
...
GX_NUMERIC_PROMPT_PROPERTIES window2_rpm_prompt_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET window2_rpm_prompt_define =
{
    "rpm_prompt",
    ...
    {69, 181, 148, 204},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_rpm_prompt), /* control block      */
    (void *) &window2_rpm_prompt_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_window2_text_define =
{
    ...
    &window2_rpm_prompt_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_PROMPT_PROPERTIES window1_window1_text_rpm_properties =
{
    GX_STRING_ID_STRING_4,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES window1_win1_prompt_properties =
{
...
GX_PROMPT_PROPERTIES window1_win1_prompt_sp_properties =
{
    GX_STRING_ID_STRING_8,                   /* string id                      */
    GX_FONT_ID_TEXT_INPUT,                   /* font id                        */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal text color              */
...
GX_PROMPT_PROPERTIES window1_win1_prompt_dc_properties =
{
    GX_STRING_ID_STRING_8,                   /* string id                      */
    GX_FONT_ID_TEXT_INPUT,                   /* font id                        */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal text color              */
...
GX_PROMPT_PROPERTIES window1_window1_text_sp_properties =
{
...
GX_PROMPT_PROPERTIES window1_window1_text_dc_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window1_window1_text_dc_define =
{
    "window1_text_dc",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WINDOW1_TEXT_DC,                      /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {6, 210, 91, 233},                       /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_window1_text_dc), /* control block */
    (void *) &window1_window1_text_dc_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window1_window1_text_sp_define =
{
    "window1_text_sp",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WINDOW1_TEXT_SP,                      /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {9, 175, 88, 198},                       /* widget size                    */
    &window1_window1_text_dc_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_window1_text_sp), /* control block */
    (void *) &window1_window1_text_sp_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window1_win1_prompt_dc_define =
{
    "win1_prompt_dc",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WIN1_DC,                              /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_RECESSED|GX_STYLE_TEXT_LEFT,   /* style flags              */
    0,                                       /* status flags                   */
    sizeof(GX_PROMPT),                       /* control block size             */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {104, 209, 183, 232},                    /* widget size                    */
    &window1_window1_text_sp_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_win1_prompt_dc), /* control block  */
    (void *) &window1_win1_prompt_dc_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window1_win1_prompt_sp_define =
{
    "win1_prompt_sp",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WIN1_SP,                              /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_RECESSED|GX_STYLE_TEXT_LEFT,   /* style flags              */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {103, 172, 182, 195},                    /* widget size                    */
    &window1_win1_prompt_dc_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_win1_prompt_sp), /* control block  */
    (void *) &window1_win1_prompt_sp_properties /* extended properties         */
};
...
GX_CONST GX_STUDIO_WIDGET window1_instructions_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {12, 63, 231, 107},                      /* widget size                    */
    &window1_win1_prompt_sp_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window1_win1_prompt_define =
{
    "win1_prompt",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WIN1_RPM,                             /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_RECESSED|GX_STYLE_TEXT_LEFT,   /* style flags              */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {103, 137, 182, 160},                    /* widget size                    */
    &window1_buttonenabler_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_win1_prompt), /* control block     */
    (void *) &window1_win1_prompt_properties /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_window1_text_rpm_define =
{
    "window1_text_rpm",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_WINDOW1_TEXT_RPM,                     /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_TEXT_RIGHT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {9, 139, 88, 162},                       /* widget size                    */
    &window1_win1_prompt_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_window1_text_rpm), /* control block */
    (void *) &window1_window1_text_rpm_properties /* extended properties       */
};
...
GX_CONST GX_STUDIO_WIDGET window1_windowchanger_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {33, 258, 212, 307},                     /* widget size                    */
    &window1_window1_text_rpm_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
