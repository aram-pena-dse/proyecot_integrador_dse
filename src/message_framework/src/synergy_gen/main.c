...
extern void output_thread_create(void);
extern void sensor_thread1_create(void);
extern void sensor_thread2_create(void);
extern void computation_thread_create(void);
...
void tx_application_define(void * first_unused_memory)
{
    ...
    output_thread_create ();
    sensor_thread1_create ();
    sensor_thread2_create ();
    computation_thread_create ();
