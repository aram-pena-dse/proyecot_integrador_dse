...
#endif
static uint8_t output_thread_stack[800] BSP_PLACE_IN_SECTION(".stack.output_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
...
void output_thread_create(void)
{
    ...
    tx_thread_create (&output_thread, (CHAR *) "Output Thread", output_thread_func, (ULONG) NULL, &output_thread_stack,
                      800, 1, 1, 1, TX_AUTO_START);
}
